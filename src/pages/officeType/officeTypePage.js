            ...
            <div className="table-settings mb-4">
                <Row className="justify-content-between align-items-center">
                    <Col>
                        <div className="btn-toolbar mb-2 mb-md-0">
                            <ButtonGroup>
                                <Button variant="outline-primary" size="sm" onClick={createModule}>Create Office Type</Button>
                            </ButtonGroup>
                        </div>
                    </Col>
                    <Col xs={6} md={6} lg={3} xl={4}>
                        <InputGroup>
                            ...
                            <Form.Control type="text" placeholder="Search by office type name" onChange={(e) => setSearch(e.target.value)} />
                        </InputGroup>
                    </Col>
