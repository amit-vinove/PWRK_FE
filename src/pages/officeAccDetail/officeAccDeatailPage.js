        ...
        <>
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                <div className="d-block mb-4 mb-md-0">
                    <h4>Office Account Detail Dashboard</h4>
                </div>
          ...
          <ButtonGroup>
                ...
                <Row className="justify-content-between align-items-center">
                    ...
                    <Col xs={6} md={6} lg={3} xl={4}>
                        <InputGroup>
                            ...
                            <Form.Control type="text" placeholder="Search by office acc name" onChange={(e) => setSearch(e.target.value)} />
                        </InputGroup>
                    </Col>
            ...
            <OfficeAccDetailTable searchText={Search} />
        </>
    );
}
